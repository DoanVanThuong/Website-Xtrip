...
import {TourFilter, Tour, TourFilterOption, TourRepo, TourSearch} from '../../../../../../common';
import {TourFilterOptionsPopup} from '../../../../../../components';
import {ActivatedRoute} from '@angular/router';

@Component({
  selector: 'tour-filter-mobile-popup',
  templateUrl: './tour-filter-mobile.popup.html',
  styleUrls: ['./tour-filter-mobile.popup.less'],
...
export class TourFilterPopup extends PopupBase {
  ...
  checkDisableReset = () => {
    return !(this.filter.countFilter(this.originalOptions) > 0);
  };
}
