...
@Component({
  selector: 'more-faq-desktop',
  templateUrl: './faq-desktop.component.html',
  styleUrls: ['./faq-desktop.component.less'],
  encapsulation: ViewEncapsulation.None
})
export class FaqDesktopComponent extends AppBase {

  selectedFaq: string = 'flight';
  ...
  questions: Array<any> = [
    {
      ...
      'questions': [
        ...
        {
          question: 'Tôi có thể yêu cầu hoàn hoặc hủy các dịch vụ tôi đã đặt không?',
          answer: 'Tùy vào từng loại dịch vụ có chính sách hoàn, hủy khác nhau, bạn vui lòng xem kỹ chính sách dịch vụ. Trong số rất ít trường hợp dịch vụ bạn đã đặt bị hủy do nhà cung cấp, chúng tôi sẽ hỗ trợ bạn chọn đặt vào một ngày khác hoặc hoàn tiền. Bạn có thể liên hệ với nhân viên bộ phận hỗ trợ khách hàng của Xtrip qua số hotline 1800 6782 (1000đ/phút ) hoặc bạn gửi email support@xtrip.vn nhé.'
        },
        {
          question: 'Trường hợp voucher của tôi được hoàn thì tôi sẽ nhận tiền hoàn như thế nào?',
          answer: 'Trường hợp voucher của bạn được hoàn Xtrip sẽ thực hiện hoàn tiền theo hình thức bạn đã thanh toán trước đó.'
        },
        {
          question: 'Thời gian tôi nhận được tiền hoàn là bao lâu?',
          answer: 'Tùy theo hình thức bạn đã thanh toán trước đó, thời gian hoàn tiền sẽ được nhân viên bộ phận hỗ trợ khách hàng phụ trách thông báo với bạn.'
        },
        {
          question: 'Với những dịch vụ không được hoàn, tôi có thể yêu cầu hoàn vì lý do đặc biệt như chuyến bay bị hủy, trễ chuyến bay không?',
          answer: 'Với các trường hợp đặc biệt này bạn vui lòng liên hệ với nhà cung cấp để thông tin chuyến bay của bạn bị hủy hoặc trễ chuyến. Đồng thời bạn báo cho Xtrip để chúng tôi kịp thời hỗ trợ bạn. Bạn vui lòng gửi email support@xtrip.vn hoặc gọi chúng tôi qua số hotline 1800 6782 (1000đ/phút).'
        },
        {
          question: 'Tôi có phải sử dụng voucher của mình vào ngày xác định không?',
          answer: 'Với hầu hết các dịch vụ tour ngày, hoạt động vui chơi, vận chuyển voucher của bạn chỉ áp dụng vào các ngày bạn đã chọn khi đặt. Với hầu hết các vé tham quan, sim và WiFi bạn có thể đi vào bất kỳ ngày nào trong hạn sử dụng của voucher. Bạn vui lòng đọc kỹ phần \'Cách sử dụng\' ở trang thông tin dịch vụ hoặc trên email xác nhận đặt chỗ của bạn để kiểm tra ngày sử dụng.'
        },
        {
          question: 'Tôi muốn thay đổi thông tin khách hàng sau khi có e-voucher không?',
          answer: 'Bạn liên hệ bộ phận chăm sóc khách hàng của Xtrip qua số hotline 18006782 (1000đ/ phút), bạn cũng có thể gửi "Yêu cầu hỗ trợ" trên App Xtrip hoặc qua email support@xtrip.vn, chúng tôi sẽ liên lạc để hỗ trợ bạn sớm nhất có thể.'
        },
        {
          question: 'Làm sao để tôi biết đường đi đến địa điểm hoạt động?',
          answer: 'Bạn vui lòng kiểm tra phần \'Cách sử dụng\' của thông tin dịch vụ hoặc trên email xác nhận đặt chỗ của bạn để biết thêm địa điểm của dịch vụ để đến đó nhé.'
        },
        {
          question: 'Làm sao để tôi có thể liên hệ nhà cung cấp dịch vụ khi tôi đến?',
          answer: ' Sau khi hoàn tất đặt chỗ, Xtrip sẽ cung cấp cho bạn số điện thoại liên lạc và email của nhà cung cấp dịch vụ trong email xác nhận đặt chỗ.  Ngay cả khi bạn đang ở quốc gia khác, bạn có thể gửi "Yêu cầu hỗ trợ" trên App và nhân viên bộ phận phục vụ khách hàng sẽ tư vấn ngay cho bạn.'
        },
        {
          question: 'Khi tôi đến nơi tôi không thể liên hệ với nhà cung cấp dịch vụ thì tôi phải làm sao?',
          answer: 'Nếu bạn không thể liên hệ được với công ty tour bạn đã đặt, bạn vui lòng thông báo cho Xtrip tại mục “Yêu cầu hỗ trợ” chúng tôi sẽ làm việc lại với đối tác và hỗ trợ bạn ngay nhé.'
        },
      ]
    },
    {
      'heading': 'Tour trong ngày, vé tham quan, vui chơi',
      'key': 'activities',
      'icon': 'assets/images/faq/general/title.svg',
      'questions': [
        {
          question: 'Tôi muốn mua các dịch vụ vui chơi, tham quan hoặc tour ngày thì phải làm như thế nào?',
          answer: 'Trên App Xtrip, bạn chọn icon tour ngày, vé vui chơi hoặc vé tham quan. Bạn điền địa điểm đến và chọn gói dịch vụ, thời gian và số lượng mà bạn muốn. Sau đó bạn chọn \'Đặt\' và hoàn tất thanh toán nhé. '
        },
        {
          question: 'Khi đặt dịch vụ vui chơi, tham quan hoặc tour ngày tôi cần đăng kí các thông tin nào?',
          answer: 'Để đặt dịch vụ qua Xtrip, bạn đăng nhập tài khoản và điền thông tin của khách hàng. Tùy từng dịch vụ cụ thể, bạn có thể điền thêm các thông tin liên quan như điểm đón khách, điểm giao hàng, thời gian cụ thể...'
        },
        {
          question: 'Sau khi thanh toán thành công tôi có thể nhận vé ở đâu?',
          answer: 'Để đặt dịch vụ qua Xtrip, bạn đăng nhập tài khoản và điền thông tin của khách hàng. Tùy từng dịch vụ cụ thể, bạn có thể điền thêm các thông tin liên quan như điểm đón khách, điểm giao hàng, thời gian cụ thể...'
        },
        {
          question: 'Sau bao lâu tôi mới nhận được voucher đã đặt dịch vụ?',
          answer: 'Các hoạt động khác nhau có thời gian xác nhận khác nhau, tùy theo thông tin được ghi chú trên mỗi dịch vụ. Hầu hết các dịch vụ đều được xác nhận tức thời trong vòng x phút, tối đa trong vòng x giờ.'
        },
        {
          question: 'Làm sao tôi biết được đơn hàng của mình có được xác nhận hay không?',
          answer: 'Trên App Xtrip, sau khi thanh toán, bạn chọn mục \'Đặt chỗ của tôi\' để xem tình trạng xác nhận của đơn hàng đã có code. Bạn cũng có thể chat hoặc gửi email xác nhận với nhà cung cấp dịch vụ.'
        },
        {
          question: 'Tôi phải làm gì khi tôi đã đặt dịch vụ nhưng chưa nhận voucher qua email?',
          answer: 'Bạn vui lòng kiểm tra kỹ hộp thư đến và mục spam. Nếu vẫn chưa có, bạn vui lòng liên hệ bộ phận chăm sóc khách hàng của Xtrip qua số hotline <a href="tel:18006782">18006782</a>  (1000đ/ phút) hoặc qua email <a href="mailto:support@xtrip.vn">support@xtrip.vn</a>.'
        },
        {
          question: 'Các dịch vụ có bị giới hạn số lượng người trên một đặt chỗ hay không? Mỗi đặt chỗ có quy định số lượng trẻ em hay em bé không?',
          answer: 'Tùy vào loại dịch vụ bạn muốn chọn. Với mỗi dịch vụ sẽ có quy định về số lượng trẻ em và em bé khác nhau.'
        },
        {
          question: 'Khách có thể đặt chỗ trước và thanh toán sau khi đến nơi tham quan không?',
          answer: 'Với các dịch vụ đặt qua Xtrip, bạn vui lòng thanh toán trước Xtrip rất tiếc chưa hỗ trợ thanh toán sau.'
        }
      ]
    },
    {
      ...
      'questions': [
        ...
        },
        {
          ...
          answer: 'Trong một số trường hợp tiến trình thanh toán có thể kéo dài hơn bình thường. Nếu giao dịch đầu tiên không thành công, bạn hãy tải lại trang thanh toán. Hãy đảm bảo rằng bạn đã nhập chính xác thông tin thẻ tín dụng trước khi tiến hành thanh toán lại. Nếu cần thêm thông tin, bạn vui lòng liên hệ bộ phận phục vụ Khách hàng của Xtrip số <a href="tel:18006782">1800 6782</a> để được hỗ trợ tốt nhất.'
        },
        {
        ...
        {
          question: 'Ngoài số tiền mua dịch vụ tôi có phải chịu thêm chi phí nào khác phát sinh khi sử dụng dịch vụ không? ',
          answer: 'Xtrip không thu bất kỳ khoản phí xử lý nào khác ngoài số tiền bạn mua dịch vụ trên App và trang web của chúng tôi.'
        },
        {
          question: 'Xtrip thanh toán bằng đơn vị tiền tệ nào?  Tôi có thể dùng tiền tệ khác để thanh toán không nếu tôi đang ở nước ngoài?',
          answer: 'App Xtrip hiện thanh toán bằng tiền Việt Nam. Trường hợp bạn đang đi du lịch nước khác, bạn có thể chọn thanh toán qua thẻ tín dụng, ATM hoặc chuyển khoản internet banking.'
        },
      ]
    },
    {
      ...
      'questions': [
        ...
        },
        {
          ...
          answer: 'Trên App Xtrip bạn cần đăng nhập tài khoản và chọn vé vui chơi, vé tham quan, vận chuyển, WiFi hoặc tour ngày bạn muốn.Nhập mã giảm giá khi thanh toán.Kiểm tra lại các thông tin đặt chỗ của bạn.Hoàn tất giao dịch.'
        }
      ]
    },
    {
      'heading': 'Điểm thưởng của tôi',
      'key': 'my-point',
  ...
  ngOnInit(): void {
    this._activatedRoute.queryParams.subscribe((params: any) => {
      if (_.isEmpty(params)) {
        this.questions = this.questions.filter(item => item.key === 'flight') || [];
      }
      //theo module
      if (!!params.faq && !params.key) {
        this.isSearch = false;

        this.selectedFaq = params.faq;
        this.params = {
          type: 'faq',
          key: this.selectedFaq || 'flight'
        };
        this.questions = this.questions.filter(item => item.key === this.selectedFaq) || [];
      }
      // theo keyword
      if (!!params.key) {
        this.isSearch = true;
        ...
        this.questions = this.handelSearch(this.questions, this.keyword || 'flight');
      }
  ...
  //fn search faq
  handelSearch(list: any[], keyword: string): any {
    let temp = [];
    list.map(item => {
      temp = temp.concat(item.questions);
    });
    return temp.filter(i => {
      return i.question.toLowerCase().search(keyword.toLowerCase()) !== -1
        || i.answer.toLowerCase().search(keyword.toLowerCase()) !== -1;
    });
  }
}
