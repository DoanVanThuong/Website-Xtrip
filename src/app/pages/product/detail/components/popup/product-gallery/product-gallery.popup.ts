...
@Component({
    selector: 'product-gallery-popup',
    templateUrl: './product-gallery.popup.html',
    styleUrls: ['./product-gallery.popup.less'],
    encapsulation: ViewEncapsulation.None
})
export class ProductGalleryPopupComponent extends PopupBase {
